...
<head>
    <meta charset="utf-8">
    <title>Attendance Discrepancy Report</title>
    <style>
        body {
...
<body>
    <table class="header-table">
        ...
        <tr>
            <td class="title">Attendance Discrepancy Report <small>({{ dateFormat($period_start) }} to {{ dateFormat($period_end) }})</small></td>
        </tr>
    </table>
    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th style="width: 20%; text-align: left;">Duty Start/End</th>
